...
const char *kHdmiRxProviderName = "hdmirx/0";
...
ICameraProvider* HIDL_FETCH_ICameraProvider(const char* name) {
	...
	ALOGE("%s: HIDL_FETCH_ICameraProvider instance name: %s", __FUNCTION__, name);
	
	if (strcmp(name, kHdmiRxProviderName) == 0) {
		provider = getProviderImpl<HdmiRxCameraProviderImpl_2_4>();
	}else {
