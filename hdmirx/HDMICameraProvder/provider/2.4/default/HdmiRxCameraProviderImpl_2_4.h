...
#ifndef ANDROID_HARDWARE_CAMERA_PROVIDER_V2_4_HDMIRXCAMERAPROVIDER_H
#define ANDROID_HARDWARE_CAMERA_PROVIDER_V2_4_HDMIRXCAMERAPROVIDER_H
 ...
 * UVC driver.
 */
struct HdmiRxCameraProviderImpl_2_4 {
    HdmiRxCameraProviderImpl_2_4();
    ~HdmiRxCameraProviderImpl_2_4();
...
private:
    ...
    void addHdmirxCamera(const char* devName);
    ...
    void updateRXStatus(int lock);

    class HotplugThread : public android::Thread {
    public:
        HotplugThread(HdmiRxCameraProviderImpl_2_4* parent);
        ~HotplugThread();
    ...
    private:
        HdmiRxCameraProviderImpl_2_4* mParent = nullptr;
