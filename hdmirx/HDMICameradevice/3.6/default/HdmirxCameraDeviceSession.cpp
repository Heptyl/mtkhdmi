...
#define LOG_TAG "HdmirxCamDevSsn@3.6"
...
HdmirxCameraDeviceSession::HdmirxCameraDeviceSession(
        ...
        unique_fd v4l2Fd) :
        V3_5::implementation::HdmirxCameraDeviceSession(
...
Return<void> HdmirxCameraDeviceSession::configureStreams_3_6(
...
Return<void> HdmirxCameraDeviceSession::switchToOffline(
...
void HdmirxCameraDeviceSession::fillOutputStream3_6(
...
bool HdmirxCameraDeviceSession::supportOfflineLocked(int32_t streamId) {
...
bool HdmirxCameraDeviceSession::canDropRequest(const hidl_vec<int32_t>& offlineStreams,
...
void HdmirxCameraDeviceSession::fillOfflineSessionInfo(const hidl_vec<int32_t>& offlineStreams,
...
Status HdmirxCameraDeviceSession::switchToOffline(const hidl_vec<int32_t>& offlineStreams,
    ...
    sp<HdmirxCameraOfflineSession> sessionImpl = new HdmirxCameraOfflineSession(
