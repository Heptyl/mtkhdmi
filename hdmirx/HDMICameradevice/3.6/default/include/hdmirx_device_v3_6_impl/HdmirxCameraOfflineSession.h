...
#ifndef ANDROID_HARDWARE_CAMERA_DEVICE_V3_6_HDMIRXCAMERAOFFLINESESSION_H
#define ANDROID_HARDWARE_CAMERA_DEVICE_V3_6_HDMIRXCAMERAOFFLINESESSION_H
...
#include <deque>
#include <../../../../3.4/default/include/hdmirx_device_v3_4_impl/HdmirxCameraUtils.h>
#include <../../../../3.5/default/include/hdmirx_device_v3_5_impl/HdmirxCameraDeviceSession.h>
...
using ::android::hardware::camera::hdmirx::common::SizeHasher;
...
struct HdmirxCameraOfflineSession : public virtual RefBase,
        public virtual OutputThreadInterface {

    HdmirxCameraOfflineSession(
    ...
    virtual ~HdmirxCameraOfflineSession();
...
protected:
    ...
    virtual void setGrallocBufferStatus(int index) {};
    ...
    class OutputThread : public V3_5::implementation::HdmirxCameraDeviceSession::OutputThread {
    public:
        OutputThread(
                wp<OutputThreadInterface> parent, CroppingType ct,
                const common::V1_0::helper::CameraMetadata& chars,
                sp<V3_5::implementation::HdmirxCameraDeviceSession::BufferRequestThread> bufReqThread,
                std::deque<std::shared_ptr<HalRequest>>& offlineReqs) :
                V3_5::implementation::HdmirxCameraDeviceSession::OutputThread(
    ...
    sp<V3_5::implementation::HdmirxCameraDeviceSession::BufferRequestThread> mBufferRequestThread;
    sp<OutputThread> mOutputThread;
private:

    struct TrampolineSessionInterface_3_6 : public ICameraOfflineSession {
        TrampolineSessionInterface_3_6(sp<HdmirxCameraOfflineSession> parent) :
                mParent(parent) {}
    ...
    private:
        sp<HdmirxCameraOfflineSession> mParent;
    };
};
...
#endif  // ANDROID_HARDWARE_CAMERA_DEVICE_V3_6_HDMIRXCAMERAOFFLINESESSION_H
