...
#ifndef ANDROID_HARDWARE_CAMERA_DEVICE_V3_6_HDMIRXCAMERADEVICESESSION_H
#define ANDROID_HARDWARE_CAMERA_DEVICE_V3_6_HDMIRXCAMERADEVICESESSION_H
...
struct HdmirxCameraDeviceSession : public V3_5::implementation::HdmirxCameraDeviceSession {
...
private:
    ...
    struct TrampolineSessionInterface_3_6 : public ICameraDeviceSession {
        TrampolineSessionInterface_3_6(sp<HdmirxCameraDeviceSession> parent) :
                mParent(parent) {}
...
#endif  // ANDROID_HARDWARE_CAMERA_DEVICE_V3_6_HDMIRXCAMERADEVICESESSION_H
