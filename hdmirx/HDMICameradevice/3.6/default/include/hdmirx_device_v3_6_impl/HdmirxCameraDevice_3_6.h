...
#ifndef ANDROID_HARDWARE_CAMERA_DEVICE_V3_6_HDMIRXCAMERADEVICE_H
#define ANDROID_HARDWARE_CAMERA_DEVICE_V3_6_HDMIRXCAMERADEVICE_H

#include <android/hardware/camera/device/3.6/ICameraDevice.h>

#include "HdmirxCameraDeviceSession.h"
#include <../../../../3.5/default/include/hdmirx_device_v3_5_impl/HdmirxCameraDevice_3_5.h>
 ...
 */
struct HdmirxCameraDevice : public V3_5::implementation::HdmirxCameraDevice {
...
private:
    struct TrampolineDeviceInterface_3_6 : public ICameraDevice {
        TrampolineDeviceInterface_3_6(sp<HdmirxCameraDevice> parent) :
            mParent(parent) {}
...
#endif  // ANDROID_HARDWARE_CAMERA_DEVICE_V3_6_HDMIRXCAMERADEVICE_H
