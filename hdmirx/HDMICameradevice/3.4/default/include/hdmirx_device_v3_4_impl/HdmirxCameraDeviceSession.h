...
#ifndef ANDROID_HARDWARE_CAMERA_DEVICE_V3_4_HDMIRXCAMERADEVICESESSION_H
#define ANDROID_HARDWARE_CAMERA_DEVICE_V3_4_HDMIRXCAMERADEVICESESSION_H
...
#define GRALLOC_BUFFER_MAX_NUM 4
...
using ::android::hardware::camera::hdmirx::hdmi::HDMIRX_DEV_INFO;


struct HdmirxCameraDeviceSession : public virtual RefBase,
        public virtual OutputThreadInterface {

    HdmirxCameraDeviceSession(const sp<ICameraDeviceCallback>&,
            ...
            unique_fd v4l2Fd);
    virtual ~HdmirxCameraDeviceSession();
    // Call by CameraDevice to dump active device states
    void dumpState(const native_handle_t*);
    // Caller must use this method to check if CameraDeviceSession ctor failed
    bool isInitFailed();
    bool isClosed();
    bool checkHdcpVersionProperty(void);
    ...
    mutable std::mutex mGrallocBufferLock;
    struct gralloc_buffer interBuffers[GRALLOC_BUFFER_MAX_NUM];

    int getGrallocBufferIndex();
...
protected:
    virtual void setGrallocBufferStatus(int index) override;
    ...
    status_t fillHdmiRxInfoResult(common::V1_0::helper::CameraMetadata &md,
...
private:
    ...
    struct TrampolineSessionInterface_3_4 : public ICameraDeviceSession {
        TrampolineSessionInterface_3_4(sp<HdmirxCameraDeviceSession> parent) :
                mParent(parent) {}
    ...
    private:
        sp<HdmirxCameraDeviceSession> mParent;
    };
};
