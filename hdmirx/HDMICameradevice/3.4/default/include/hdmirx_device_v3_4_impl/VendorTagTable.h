...
#ifndef UTILS_METACONV_VENDORTAG_VENDORTAGTABLE_H_
#define UTILS_METACONV_VENDORTAG_VENDORTAGTABLE_H_
...
//#include "mtkcam-halif/utils/metadata_tag/1.x/custom/custom_vendortag_table.h"

/******************************************************************************
 *
 ******************************************************************************/
static auto& _Camera_() {
  static const std::map<uint32_t, VendorTag_t> sInst = {
      _TAG_(MTK_CAMERA_TYPE, "type", TYPE_BYTE),
      _TAG_(MTK_CAMERA_HDMI_RX_INFO, "hdmi.rx.info", TYPE_INT32),
      _TAG_(MTK_CAMERA_MDP_PROFILE, "mdp.profile", TYPE_INT32)
  };
  //
  return sInst;
}
...
static auto& getGlobalSections() {
  static std::vector<VendorTagSection_t> sMTKSections = {
      _SECTION_("camera", MTK_CAMERA_START, MTK_CAMERA_END, _Camera_())
  };
...
#endif  // UTILS_METACONV_VENDORTAG_VENDORTAGTABLE_H_
