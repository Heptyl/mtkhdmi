...
#ifndef INCLUDE_MTKCAM_INTERFACES_UTILS_METADATA_IVENDORTAGDESCRIPTOR_H_
#define INCLUDE_MTKCAM_INTERFACES_UTILS_METADATA_IVENDORTAGDESCRIPTOR_H_
//
#include <map>
#include <vector>
...
#endif  //  INCLUDE_MTKCAM_INTERFACES_UTILS_METADATA_IVENDORTAGDESCRIPTOR_H_
