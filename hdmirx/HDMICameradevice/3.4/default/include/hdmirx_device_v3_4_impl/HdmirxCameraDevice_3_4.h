...
#ifndef ANDROID_HARDWARE_CAMERA_DEVICE_V3_4_HDMIRXCAMERADEVICE_H
#define ANDROID_HARDWARE_CAMERA_DEVICE_V3_4_HDMIRXCAMERADEVICE_H
 ...
 */
struct HdmirxCameraDevice : public virtual RefBase {
...
protected:
    ...
    // HdmirxCameraDeviceSession
    virtual sp<HdmirxCameraDeviceSession> createSession(
    ...
    wp<HdmirxCameraDeviceSession> mSession = nullptr;
...
private:
    ...
    struct TrampolineDeviceInterface_3_4 : public ICameraDevice {
        TrampolineDeviceInterface_3_4(sp<HdmirxCameraDevice> parent) :
            mParent(parent) {}
...
#endif  // ANDROID_HARDWARE_CAMERA_DEVICE_V3_4_HDMIRXCAMERADEVICE_H
