...
#ifndef ANDROID_HARDWARE_CAMERA_DEVICE_V3_5_HDMIRXCAMERADEVICESESSION_H
#define ANDROID_HARDWARE_CAMERA_DEVICE_V3_5_HDMIRXCAMERADEVICESESSION_H

#include <android/hardware/camera/device/3.5/ICameraDeviceCallback.h>
#include <android/hardware/camera/device/3.5/ICameraDeviceSession.h>
#include <../../../../3.4/default/include/hdmirx_device_v3_4_impl/HdmirxCameraDeviceSession.h>
...
struct HdmirxCameraDeviceSession : public V3_4::implementation::HdmirxCameraDeviceSession {

    HdmirxCameraDeviceSession(const sp<V3_2::ICameraDeviceCallback>&,
    ...
    static Status isStreamCombinationSupported(const V3_2::StreamConfiguration& config,
        ...
        return V3_4::implementation::HdmirxCameraDeviceSession::isStreamCombinationSupported(
    ...
    class OutputThread :
            public V3_4::implementation::HdmirxCameraDeviceSession::OutputThread {
    public:
...
private:
    ...
    struct TrampolineSessionInterface_3_5 : public ICameraDeviceSession {
        TrampolineSessionInterface_3_5(sp<HdmirxCameraDeviceSession> parent) :
                mParent(parent) {}
...
#endif  // ANDROID_HARDWARE_CAMERA_DEVICE_V3_5_HDMIRXCAMERADEVICESESSION_H
