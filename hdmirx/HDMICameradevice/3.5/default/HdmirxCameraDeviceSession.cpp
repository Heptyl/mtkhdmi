...
#define LOG_TAG "HdmirxCamDevSsn@3.5"
...
HdmirxCameraDeviceSession::HdmirxCameraDeviceSession(
        ...
        unique_fd v4l2Fd) :
        V3_4::implementation::HdmirxCameraDeviceSession(
...
Return<void> HdmirxCameraDeviceSession::configureStreams_3_5(
...
Return<void> HdmirxCameraDeviceSession::signalStreamFlush(
...
HdmirxCameraDeviceSession::BufferRequestThread::BufferRequestThread(
        wp<OutputThreadInterface> parent,
        sp<V3_5::ICameraDeviceCallback> callbacks) :
        mParent(parent),
        mCallbacks(callbacks) {}

int HdmirxCameraDeviceSession::BufferRequestThread::requestBufferStart(
...
int HdmirxCameraDeviceSession::BufferRequestThread::waitForBufferRequestDone(
...
void HdmirxCameraDeviceSession::BufferRequestThread::waitForNextRequest() {
    ATRACE_CALL();
    std::unique_lock<std::mutex> lk(mLock);
    int waitTimes = 0;
...
bool HdmirxCameraDeviceSession::BufferRequestThread::threadLoop() {
    waitForNextRequest();
    if (exitPending()) {
        return false;
    }
...
void HdmirxCameraDeviceSession::closeOutputThread() {
    closeOutputThreadImpl();
    V3_4::implementation::HdmirxCameraDeviceSession::closeOutputThread();
}
...
HdmirxCameraDeviceSession::OutputThread::OutputThread(
        ...
        V3_4::implementation::HdmirxCameraDeviceSession::OutputThread(parent, ct, chars),
        mBufferRequestThread(bufReqThread) {}

HdmirxCameraDeviceSession::OutputThread::~OutputThread() {}

int HdmirxCameraDeviceSession::OutputThread::requestBufferStart(
...
int HdmirxCameraDeviceSession::OutputThread::waitForBufferRequestDone(
...
Return<void> HdmirxCameraDeviceSession::isReconfigurationRequired(
